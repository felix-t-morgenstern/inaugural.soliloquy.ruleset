...
public class StatisticChangeMagnitudeFactoryTests {
    ...
    private Function<StatisticChangeMagnitudeDefinition, StatisticChangeMagnitude> factory;

    @BeforeEach
    public void setUp() {
        lenient().when(mockGetVariableStatType.apply(anyString())).thenReturn(mockVariableStatType);

        lenient().when(mockGetElement.apply(anyString())).thenReturn(mockElement);
    ...
    @Test
    public void testMakeWithValueAndOnlyPerLevel() {
        var definition = new StatisticChangeMagnitudeDefinition(VARIABLE_STAT_TYPE_ID, ELEMENT_ID,
                DAMAGE.name(), VALUE.name(),
    ...
    @Test
    public void testMakeWithValueAndOnlyAbsolute() {
        var definition = new StatisticChangeMagnitudeDefinition(VARIABLE_STAT_TYPE_ID, ELEMENT_ID,
    ...
    @Test
    public void testMakeWithPercent() {
        var definition = new StatisticChangeMagnitudeDefinition(VARIABLE_STAT_TYPE_ID, ELEMENT_ID,
    ...
    @Test
    public void testMakeWithPercentAndOnlyPerLevel() {
        var definition = new StatisticChangeMagnitudeDefinition(VARIABLE_STAT_TYPE_ID, ELEMENT_ID,
                DAMAGE.name(), PERCENT_OF_MAXIMUM.name(), null,
    ...
    @Test
    public void testMakeWithPercentAndOnlyAbsolute() {
        var definition = new StatisticChangeMagnitudeDefinition(VARIABLE_STAT_TYPE_ID, ELEMENT_ID,
